...
If you want to go back to your home folder, we can use `cd ..`. This might look a bit strange with the periods, but what this represents is from your current folder **(cd)**, move back one **(..)**. 
